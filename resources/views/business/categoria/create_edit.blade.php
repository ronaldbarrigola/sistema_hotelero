    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frmCategoria" enctype="multipart/form-data" onsubmit="return submitCategoria(event)">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4 offset-md-4 d-flex justify-content-between">
                            <button class="btn btn-success" id="btnGuardarCategoria" type="submit">Guardar</button>
...
@push('scripts')
  <script>
        ...
        function submitCategoria(event) {
            storeCategoria();
        ...
        function storeCategoria(){
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    ...
                    $("#btnGuardarCategoria").text("Procesando");
                },
       ...
       function dataEditCategoria($boton){
            ...
            $.ajax({
                ...
                success: function(result){
                     ...
                     $('#grupo_id').selectpicker('val',result.categoria.grupo_id);
