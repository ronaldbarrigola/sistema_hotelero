...
class HabitacionRepository{
    ...
    public function obtenerHabitaciones(){
       $habitaciones=DB::table('gob_habitacion as h')
            ...
            ->select('h.id','h.descripcion as habitacion','h.codigo','h.piso','a.nombre as agencia','th.descripcion as tipo_habitacion','eh.descripcion as estado_habitacion','h.precio','h.imagen')
            ->where('h.estado','=','1')
            ->orderBy('h.id','desc')
            ->get();
        return $habitaciones;
