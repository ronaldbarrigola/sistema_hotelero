        ...
        if($format){
            if(empty($decimales)){
               ...
               // $valor_convertido = number_format($number, 2, ',', '.') . ' (' . ucfirst($converted) . $decNumberStr . '/100 '.$currency.')';
                ...
                //$valor_convertido = ucfirst($converted) . str_pad($decNumberStr, 2, "0", STR_PAD_LEFT). '/100 '.$currency; //Rellena ceros a la izquierda
                $valor_convertido = ucfirst($converted) . str_pad($decNumberStr, 2, "0",STR_PAD_RIGHT). '/100 '.$currency; //Rellena ceros a la derecha
